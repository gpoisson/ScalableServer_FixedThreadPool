...
public class WorkerThread_old implements Runnable {
	...
	private LinkedList<WorkerThread_old> idleThreads;		// Reference to thread pool manager's list of idle threads
	...
	public WorkerThread_old(LinkedList<WorkerThread_old> idleThreads, int id, StatTracker statTracker, boolean debug) {
		this.debug = debug; 
